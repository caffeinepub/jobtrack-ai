import { c as createLucideIcon, r as reactExports, l as React, i as reactDomExports, j as jsxRuntimeExports, a as cn, S as Sparkles, u as ue, b as Skeleton } from "./index-aguMEkBW.js";
...
import { d as useUpdateApplicationStatus, b as useApplications } from "./useApplications-DXCdwNMb.js";
/**
...
const DragOverlay = /* @__PURE__ */ React.memo((_ref) => {
  ...
  const dropAnimation2 = useDropAnimation({
...
function FitBadge({ score }) {
  const colorClass = score >= 85 ? "bg-chart-3/10 text-chart-3 border-chart-3/30" : score >= 70 ? "bg-chart-2/10 text-chart-2 border-chart-2/30" : "bg-destructive/10 text-destructive border-destructive/30";
...
function KanbanCard({ app, accent, isDragging }) {
  const {
    attributes,
    listeners,
    setNodeRef,
  ...
  const isStalled = (app.status === "Applied" || app.status === "Interviewing") && days >= 14;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        isStalled && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(GripVertical, { className: "h-3.5 w-3.5 text-muted-foreground" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3.5 space-y-2.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-sm text-foreground truncate leading-tight", children: app.company }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate mt-0.5", children: app.jobTitle })
            ] }),
            app.fitScore !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(FitBadge, { score: app.fitScore })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-x-3 gap-y-1 text-xs text-muted-foreground", children: [
            app.location && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1 truncate max-w-[110px]", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "h-3 w-3 flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate", children: app.location })
            ] }),
            app.salary && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(DollarSign, { className: "h-3 w-3 flex-shrink-0" }),
              app.salary
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
                ...
                children: [
                  ...
                  isStalled ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-chart-2 animate-pulse" }),
                    "Stalled ",
                    days,
                    "d"
                  ] }) : `${days}d ago`
            ...
            app.remote && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-[10px] px-1.5 py-0", children: "Remote" })
          ] }),
          suggestion && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-2 border-t border-border/60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "inline-flex items-start gap-1.5 text-xs text-primary font-medium leading-snug", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-3 w-3 mt-0.5 flex-shrink-0 text-accent" }),
                suggestion
              ] }) })
            }
          )
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-sm text-foreground flex-1 truncate", children: label }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          ...
          {
            ref: setNodeRef,
            className: `flex-1 overflow-y-auto p-2 flex flex-col gap-2 transition-colors duration-200 ${isOver ? "bg-primary/5" : ""}`,
            style: { maxHeight: "calc(100vh - 220px)" },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SortableContext, { items: itemIds, strategy: verticalListSortingStrategy, children: items.map((app) => /* @__PURE__ */ jsxRuntimeExports.jsx(KanbanCard, { app, accent }, app.id)) }),
              items.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: `flex-1 min-h-24 rounded-lg border-2 border-dashed border-border/50 flex items-center justify-center transition-colors duration-200 ${isOver ? "border-primary/40 bg-primary/5" : ""}`,
                  "data-ocid": `kanban-empty-${id.toLowerCase()}`,
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Drop here" })
                }
              )
            ]
          }
...
function KanbanBoard({ applications }) {
  const [items, setItems] = reactExports.useState(applications);
  const [activeId, setActiveId] = reactExports.useState(null);
  const updateStatus = useUpdateApplicationStatus();
  const undoRef = reactExports.useRef(
    null
  );
  ...
  const handleDragStart = reactExports.useCallback(({ active }) => {
  ...
  const handleDragOver = reactExports.useCallback(
    ({ active, over }) => {
      ...
      const targetStatus = (overColumn == null ? void 0 : overColumn.id) ?? (overItem == null ? void 0 : overItem.status);
      if (!targetStatus || targetStatus === activeItem.status) return;
      setItems(
        (prev) => prev.map(
          (a) => a.id === activeItem.id ? { ...a, status: targetStatus } : a
        )
      );
    },
    [items]
  ...
  const handleDragEnd = reactExports.useCallback(
    ({ active, over }) => {
      ...
      const overColumn = COLUMNS.find((c) => c.id === over.id);
      const overItem = items.find((a) => a.id === over.id);
      const targetStatus = (overColumn == null ? void 0 : overColumn.id) ?? (overItem == null ? void 0 : overItem.status) ?? activeItem.status;
      const originalApp = applications.find((a) => a.id === active.id);
      const prevStatus = (originalApp == null ? void 0 : originalApp.status) ?? activeItem.status;
      ...
      undoRef.current = { id: active.id, prevStatus };
      if (undoTimerRef.current) clearTimeout(undoTimerRef.current);
      updateStatus.mutate(
        { id: active.id, status: targetStatus },
        {
          onError: () => {
            setItems(
              (prev) => prev.map(
                (a) => a.id === active.id ? { ...a, status: prevStatus } : a
              )
            );
      ...
      ue(`Moved to ${targetStatus}`, {
        ...
        action: {
          ...
          onClick: () => {
            ...
            setItems(
              (prev) => prev.map(
                (a) => a.id === undoRef.current.id ? { ...a, status: undoRef.current.prevStatus } : a
              )
            );
            updateStatus.mutate({
  ...
  const columnItems = reactExports.useCallback(
    (colId) => items.filter((a) => a.status === colId),
    [items]
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DndContext,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(DragOverlay, { dropAnimation, children: activeApp ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rotate-2 scale-105 opacity-95 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(KanbanCard, { app: activeApp, accent: "border-l-primary", isDragging: true }) }) : null })
      ]
    }
  );
}
function KanbanPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full min-h-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-6 py-5 border-b border-border bg-card flex-shrink-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 rounded-lg bg-primary/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(LayoutGrid, { className: "h-5 w-5 text-primary" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-display font-semibold text-foreground", children: "Pipeline" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: "Drag applications between stages to update their status" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ml-auto flex items-center gap-2 text-sm text-muted-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-accent/70" }),
        "Stalled > 14 days"
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-0 overflow-hidden", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-4 p-6 h-full", children: ["a", "b", "c", "d", "e"].map((key2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 w-72 flex-shrink-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-32 w-full" })
    ] }, key2)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(KanbanBoard, { applications: (data == null ? void 0 : data.applications) ?? [] }) })
  ] });
}
export {
  KanbanPage
