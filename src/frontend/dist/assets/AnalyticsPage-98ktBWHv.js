import { c as createLucideIcon, j as jsxRuntimeExports, S as Sparkles, b as Skeleton, Z as Zap, a as cn, y as commonjsGlobal, z as getDefaultExportFromCjs, r as reactExports, A as clsx, l as React, C as invariant, B as Button } from "./index-aguMEkBW.js";
import { A as ArrowRight } from "./arrow-right-Dj34t0Hi.js";
import { T as TrendingUp } from "./trending-up-BVQWt1ti.js";
import { e as useAnalytics, f as useInsights, b as useApplications } from "./useApplications-DXCdwNMb.js";
/**
...
function AiInsightsPanel({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 px-6 py-4 border-b border-border bg-gradient-to-r from-primary/5 to-transparent", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center w-8 h-8 rounded-lg bg-primary/10 border border-primary/20", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-4 h-4 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-foreground text-sm", children: "AI Insights" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Personalized analysis based on your pipeline" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-5 space-y-3", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: cn("mt-0.5 shrink-0", cfg.iconClass), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "w-4 h-4" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2 mb-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground leading-snug", children: insight.title }),
                  ...
                  insight.metric && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1.5 text-xs font-medium text-primary/80 tabular-nums", children: insight.metric }),
                  insight.action && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 flex items-center gap-1 text-xs font-semibold text-primary opacity-0 group-hover:opacity-100 transition-smooth", children: [
        ...
        recommendations && recommendations.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-5 mb-5 p-4 rounded-lg bg-primary/5 border border-primary/10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-xs font-bold uppercase tracking-widest text-primary mb-3", children: "Recommended Next Steps" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "space-y-2", children: recommendations.map((rec, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "li",
            {
              className: "flex items-start gap-2.5 text-sm text-foreground",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "shrink-0 w-5 h-5 rounded-full bg-primary/15 text-primary text-[11px] font-bold flex items-center justify-center mt-0.5", children: i + 1 }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "leading-relaxed", children: rec })
              ]
            },
            rec
          )) })
...
function MetricCard({
  ...
  const trendColor = trend === "up" ? "text-emerald-600 dark:text-emerald-400" : trend === "down" ? "text-rose-500 dark:text-rose-400" : "text-muted-foreground";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      "data-ocid": dataOcid,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-semibold uppercase tracking-widest text-muted-foreground pl-3 mb-3", children: label }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pl-3 flex items-end gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl font-bold text-foreground tabular-nums leading-none", children: value }),
          unit2 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-muted-foreground mb-0.5", children: unit2 })
        ] }),
        (trend || trendValue || description) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: cn("pl-3 mt-2.5 flex items-center gap-1.5", trendColor),
            children: [
              trend && /* @__PURE__ */ jsxRuntimeExports.jsx(TrendIcon, { className: "w-3.5 h-3.5 shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium", children: trendValue ?? description })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-xl opacity-0 group-hover:opacity-100 transition-smooth pointer-events-none bg-primary/[0.02]" })
      ]
    }
  );
}
...
function filterByRange(apps, range3) {
  if (range3 === "all") return apps;
  const days = range3 === "7d" ? 7 : range3 === "30d" ? 30 : 90;
  const cutoff = /* @__PURE__ */ new Date();
  cutoff.setDate(cutoff.getDate() - days);
  return apps.filter((a2) => new Date(a2.appliedAt) >= cutoff);
}
...
const CustomTooltip = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-lg px-3 py-2 shadow-md text-sm", children: [
    label && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground mb-1", children: label }),
    payload.map((p2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground", children: [
      p2.name,
      ":",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground tabular-nums", children: p2.value })
    ] }, p2.name))
  ] });
};
function ChartCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        ...
        subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5 mb-4", children: subtitle }),
        !subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4" }),
        children
      ]
    }
  );
...
function AnalyticsPage() {
  const [range3, setRange] = reactExports.useState("all");
  const { data: analyticsData, isLoading: analyticsLoading } = useAnalytics();
  const { data: insightsData, isLoading: insightsLoading } = useInsights();
  const { data: appsData } = useApplications();
  const allApps = (appsData == null ? void 0 : appsData.applications) ?? [];
  const filtered = reactExports.useMemo(
    () => filterByRange(allApps, range3),
    [allApps, range3]
  );
  const total = filtered.length;
  const interviews = filtered.filter(
    (a2) => a2.status === "Interviewing" || a2.status === "Offer"
  ).length;
  const offers = filtered.filter((a2) => a2.status === "Offer").length;
  const responses = filtered.filter((a2) => a2.status !== "Applied").length;
  const interviewRate = total > 0 ? Math.round(interviews / total * 100) : 0;
  const offerRate = total > 0 ? Math.round(offers / total * 100) : 0;
  const responseRate = total > 0 ? Math.round(responses / total * 100) : 0;
  const avgTimeToOffer = (analyticsData == null ? void 0 : analyticsData.avgTimeToResponse) ?? 8;
  const timelineData = reactExports.useMemo(() => {
    const buckets = {};
    for (const a2 of filtered) {
      const d2 = new Date(a2.appliedAt);
      const key = range3 === "7d" ? d2.toLocaleDateString("en-US", { weekday: "short" }) : range3 === "30d" ? `${d2.getMonth() + 1}/${d2.getDate()}` : d2.toLocaleDateString("en-US", { month: "short" });
      buckets[key] = (buckets[key] ?? 0) + 1;
    }
    if (Object.keys(buckets).length === 0) {
      return ((analyticsData == null ? void 0 : analyticsData.byMonth) ?? []).map((m2) => ({
        label: m2.month,
        count: m2.count
      }));
    }
    return Object.entries(buckets).map(([label, count]) => ({ label, count }));
  }, [filtered, range3, analyticsData]);
  const sourceData = reactExports.useMemo(() => {
    const counts = {};
    for (const a2 of filtered) {
      counts[a2.source] = (counts[a2.source] ?? 0) + 1;
    }
    return Object.entries(counts).sort((a2, b2) => b2[1] - a2[1]).map(([source, count]) => ({ source, count }));
  }, [filtered]);
  const jobTypeData = reactExports.useMemo(() => {
    const remote = filtered.filter(
      (a2) => a2.remote || a2.jobType === "remote"
    ).length;
    const hybrid = filtered.filter(
      (a2) => {
        var _a;
        return !a2.remote && ((_a = a2.location) == null ? void 0 : _a.toLowerCase().includes("hybrid"));
      }
    ).length;
  ...
  const funnelData = reactExports.useMemo(() => {
    const applied = filtered.length;
    const interview = filtered.filter(
      (a2) => a2.status === "Interviewing" || a2.status === "Offer"
    ).length;
    const offer = filtered.filter((a2) => a2.status === "Offer").length;
    return [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 md:p-8 max-w-screen-2xl mx-auto space-y-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl font-bold text-foreground", children: "Analytics" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Track your job search performance and surface strategic insights" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: Object.keys(RANGE_LABELS).map((r) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                onClick: () => setRange(r),
                className: cn(
                  ...
                  range3 === r ? "bg-card text-foreground shadow-sm border border-border/60" : "text-muted-foreground hover:text-foreground"
                ),
    ...
    analyticsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4", children: Array.from({ length: 5 }, (_, i) => i).map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-28 rounded-xl" }, `skeleton-${i}`)) }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        MetricCard,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        MetricCard,
        {
          ...
          trendValue: interviewRate >= 30 ? "Above average" : "Building pipeline",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground mb-3", children: "Activity" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ChartCard,
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground mb-3", children: "Pipeline" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ChartCard,
          {
            title: "Stage Funnel",
            subtitle: "Applied → Interview → Offer conversion",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4 mt-2", children: funnelData.map((stage, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                "data-ocid": `funnel-stage-${stage.stage.toLowerCase()}`,
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-foreground", children: stage.stage }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground tabular-nums", children: [
                        stage.pct,
                        "%"
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold text-foreground tabular-nums w-5 text-right", children: stage.count })
                    ] })
                  ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground mb-3", children: "Sources" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ChartCard, { title: "By Source", subtitle: "Applications per channel", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          BarChart,
          {
            data: sourceData,
            layout: "vertical",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground mb-3", children: "Work Type" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ChartCard,
          {
            title: "Remote vs. Onsite",
            subtitle: "Distribution across work arrangements",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Pie,
                {
                  data: jobTypeData,
                  ...
                  dataKey: "value",
                  animationDuration: 800,
                  children: jobTypeData.map((_entry, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Cell,
                    {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-widest text-muted-foreground mb-3", children: "Intelligence" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        AiInsightsPanel,
        {
          insights,
