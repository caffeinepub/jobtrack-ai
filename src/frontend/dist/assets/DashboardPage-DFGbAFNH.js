import { d as daysSince, j as jsxRuntimeExports, L as Link, f as formatDate, c as cn, r as reactExports, m as motion, u as ue } from "./index-BckjkVoS.js";
import { u as useParseJobUrl, a as useAddApplication, b as useApplications } from "./useApplications-CLSSEWV_.js";
import { A as AnimatePresence, L as LoaderCircle, C as ChevronDown } from "./loader-circle-DJ0FzzXK.js";
    ...
    parseJobUrl.mutate(url, {
      onSuccess: (result) => {
        ...
        const args = {
          ...
          appliedDate: BigInt(Date.now()) * BigInt(1e6),
          fitScore: result.fitScore !== void 0 ? BigInt(result.fitScore) : void 0,
          fitScoreConfidence: result.fitScoreConfidence !== void 0 ? BigInt(result.fitScoreConfidence) : void 0,
          salaryMin: result.salaryMin,
          salaryMax: result.salaryMax,
          aiSuggestion: result.notes || void 0
        };
