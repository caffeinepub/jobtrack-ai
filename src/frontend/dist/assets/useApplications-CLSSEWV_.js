...
import { t as ProtocolError, T as TimeoutWaitingForResponseErrorCode, v as utf8ToBytes, E as ExternalError, w as MissingRootKeyErrorCode, C as Certificate, x as lookupResultToBuffer, y as RequestStatusResponseStatus, U as UnknownError, z as RequestStatusDoneNoReplyErrorCode, A as RejectError, B as CertifiedRejectErrorCode, D as UNREACHABLE_ERROR, I as InputError, F as InvalidReadStateRequestErrorCode, G as ReadRequestType, H as Principal, J as IDL, K as MissingCanisterIdErrorCode, N as HttpAgent, O as encode, Q as QueryResponseStatus, V as UncertifiedRejectErrorCode, W as isV3ResponseBody, X as isV2ResponseBody, Y as UncertifiedRejectUpdateErrorCode, Z as UnexpectedErrorCode, _ as decode, $ as Subscribable, a0 as pendingThenable, a1 as resolveEnabled, a2 as shallowEqualObjects, a3 as resolveStaleTime, a4 as noop, a5 as environmentManager, a6 as isValidTimeout, a7 as timeUntilStale, a8 as timeoutManager, a9 as focusManager, aa as fetchState, ab as replaceData, ac as notifyManager, ad as hashKey, ae as getDefaultState, r as reactExports, af as shouldThrowError, ag as useQueryClient, ah as useInternetIdentity, ai as createActorWithConfig, aj as Variant, ak as Record, al as Opt, am as Vec, an as Service, ao as Func, ap as Nat, aq as Text, ar as Null, as as Bool, at as Int, au as Principal$1, av as Float64, aw as Nat8, e as useAppStore, u as ue } from "./index-BckjkVoS.js";
...
Service({
  ...
  "getGrokApiKey": Func([], [Opt(Text)], []),
  "getGrokModel": Func([], [Opt(Text)], []),
  ...
  "setGrokApiKey": Func([Text], [], []),
  "setGrokModel": Func([Text], [], []),
  "transform": Func(
    [TransformationInput],
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  return IDL2.Service({
    ...
    "getGrokApiKey": IDL2.Func([], [IDL2.Opt(IDL2.Text)], []),
    "getGrokModel": IDL2.Func([], [IDL2.Opt(IDL2.Text)], []),
    ...
    "setGrokApiKey": IDL2.Func([IDL2.Text], [], []),
    "setGrokModel": IDL2.Func([IDL2.Text], [], []),
    "transform": IDL2.Func(
...
function useParseJobUrl() {
  ...
  return useMutation({
    ...
    onError: (err) => {
      ue.error(err.message ?? "Failed to parse job URL");
    }
  });
}
