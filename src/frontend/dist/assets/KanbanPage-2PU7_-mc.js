import { r as reactExports, n as React, a as reactDomExports, j as jsxRuntimeExports, c as cn, u as ue } from "./index-BckjkVoS.js";
import { c as createLucideIcon } from "./createLucideIcon-C-0mSlO7.js";
import { d as useUpdateApplicationStatus, b as useApplications } from "./useApplications-CLSSEWV_.js";
/**
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2 pr-5", children: [
            ...
            app.fitScore !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "span",
              {
          ...
          (app.location || app.salary || app.remote) && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                app.location && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "truncate max-w-[100px]", children: app.location }),
                app.salary && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: app.salary }),
                app.remote && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "REMOTE" })
              ]
            }
          ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                style: {
                  ...
                  textTransform: "uppercase",
                  letterSpacing: "1.17px",
                  color: isStalled ? "rgba(240,240,250,0.65)" : "rgba(240,240,250,0.3)"
                },
                children: isStalled ? `STALLED ${days} DAYS` : `${days} DAYS`
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
          ...
          suggestion && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden transition-all duration-300 max-h-0 group-hover:max-h-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              className: "pt-2",
...
function KanbanColumn({ id, label, items }) {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(SortableContext, { items: itemIds, strategy: verticalListSortingStrategy, children: items.map((app) => /* @__PURE__ */ jsxRuntimeExports.jsx(KanbanCard, { app }, app.id)) }),
...
function KanbanBoard({ applications }) {
  ...
  const handleDragEnd = reactExports.useCallback(
    ({ active, over }) => {
      ...
      ue(`MOVED TO ${targetStatus.toUpperCase()}`, {
        duration: 5e3,
        action: {
          label: "UNDO",
          onClick: () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    DndContext,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(DragOverlay, { dropAnimation, children: activeApp ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rotate-1 scale-105 opacity-90 pointer-events-none", children: /* @__PURE__ */ jsxRuntimeExports.jsx(KanbanCard, { app: activeApp, isDragging: true }) }) : null })
      ]
    }
  );
}
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex flex-col h-full", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between px-8 pt-10 pb-6 flex-shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: "● STALLED > 14 DAYS"
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-0 overflow-hidden", children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-5 px-8 pb-8 h-full overflow-x-auto", children: ["a", "b", "c", "d", "e"].map((key2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
            ...
            key2
          )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx(KanbanBoard, { applications: (data == null ? void 0 : data.applications) ?? [] }) })
        ] })
      ]
    }
  );
